      ...
      {cart.length === 0 ? (
        ...
        <CartContent>
            ...
            <AnimatePresence>
              {cart.map(item => (
                ...
                >
                  ...
                  <ItemPrice>Rp {(item.price * 15000).toLocaleString('id-ID')}</ItemPrice>
                  ...
                  <ItemTotal>Rp {(item.price * item.quantity * 15000).toLocaleString('id-ID')}</ItemTotal>
          ...
          <CartSummary>
            ...
            <SummaryRow>
              <span>Tax (10%)</span>
              <span>Rp {(getTotalPrice() * 0.1 * 15000).toLocaleString('id-ID')}</span>
            </SummaryRow>
            ...
            <SummaryTotal>
              <span>Total</span>
              <span>Rp {(getTotalPrice() * 1.1 * 15000).toLocaleString('id-ID')}</span>
            </SummaryTotal>
